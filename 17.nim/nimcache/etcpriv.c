...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /home/marco/saus/advent-of-code-2019/17.nim/nimcache/etcpriv.o /home/marco/saus/advent-of-code-2019/17.nim/nimcache/etcpriv.c */
...
static N_INLINE(NIM_BOOL, ismagicidentseparatorrune_141020)(NCSTRING cs, NI i) {
	...
	LOC2 = ((NU8)(cs[(NI)(TMP535)]) == (NU8)(128));
	LA3: ;
	LOC1 = LOC2;
	if (!(LOC1)) goto LA4;
	nimln(23, "etcpriv.nim");
	TMP536 = addInt(i, ((NI) 2));
	LOC1 = ((NU8)(cs[(NI)(TMP536)]) == (NU8)(147));
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
