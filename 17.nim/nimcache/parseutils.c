...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /home/marco/saus/advent-of-code-2019/17.nim/nimcache/parseutils.o /home/marco/saus/advent-of-code-2019/17.nim/nimcache/parseutils.c */
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	nimln(228, "parseutils.nim");
	{
		...
		LOC9 = 0;
		LOC9 = (*e_98255).Sup.Sup.message; (*e_98255).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP281));
